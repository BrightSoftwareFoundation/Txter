...
class Txter(QMainWindow):
    ...
    def closeEvent(self, event):
        msg = QMessageBox.question(self, "Sure to close", "Are you sure to close without saving your file?", QMessageBox.Save | QMessageBox.No | QMessageBox.Cancel)
        if msg == QMessageBox.Save:
            self.file_save()
            event.accept()
        elif msg == QMessageBox.No:
